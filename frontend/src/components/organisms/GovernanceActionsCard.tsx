...
const GovernanceActionsCard = () => {
    return (
        <div className="drep_white_gradient">
            <div className="container grid grid-cols-2 gap-16 py-16">
                <div className="col-span-1 flex flex-col items-start justify-center gap-3 py-20">
                    ...
                    <p>
                        There are currently seven defined types of governance actions registered DRep will be voting on.
                    </p>
                    <p>
                        A governance
                        action is an on-chain event that is triggered by a transaction and
                        has a deadline after which it cannot be enacted.
                    </p>
