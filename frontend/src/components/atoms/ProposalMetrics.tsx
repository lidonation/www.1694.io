...
const ProposalMetrics = ({
  ...
  const { proposalMetrics: fetchedMetrics, isProposalMetricsLoading } =
    useGetProposalMetricsQuery(search, categories, committees);
  ...
  return (
    <div className="proposal_metrics mb-3 w-auto divide-y divide-gray-200">
