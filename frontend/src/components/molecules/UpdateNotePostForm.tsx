...
const UpdateNotePostForm = ({register, control, errors}) => {
  ...
  return (
    <div className="flex flex-col gap-3 mt-3">
      <PostInput inputName={"Note Title"} id={'postTitle'} placeholder={"Note Title"}  registerValue={register} errors={errors} dataTestId={'post-title-input'}/>
      <PostInput inputName={"Tags"} id={'postTag'} placeholder={"Note Tags"} registerValue={register} errors={errors} dataTestId={'post-tag-input'}/>
