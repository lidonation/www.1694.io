...
export const TWITTER_REGEX =/^https?:\/\/(www\.)?x\.com\/[a-zA-Z0-9-]+(\/)?$/
export const FACEBOOK_REGEX =/^https?:\/\/(www\.)?facebook\.com\/[a-zA-Z0-9-]+(\/)?$/
export const INSTAGRAM_REGEX =/^https?:\/\/(www\.)?instagram\.com\/[a-zA-Z0-9-]+(\/)?$/
