...
import { JobTypes, Queues, StakeSyncJobData, StakeSyncJobResponse } from '../queue.types';
...
export class StakeSyncProcessor extends WorkerHost {
  private readonly logger = new Logger(StakeSyncProcessor.name);
          ...
          if (drepInfo && drepInfo.amount) {
            ...
            await drepsRepository.update(
              ...
              { 
                ...
                retired: drepInfo.retired,
                expired: drepInfo.expired,
