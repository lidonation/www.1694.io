...
import { JobTypes, Queues, ProposalsSyncJobData, ProposalsSyncJobResponse } from '../queue.types';
...
export class ProposalsSyncProcessor extends WorkerHost {
  private readonly logger = new Logger(ProposalsSyncProcessor.name);
