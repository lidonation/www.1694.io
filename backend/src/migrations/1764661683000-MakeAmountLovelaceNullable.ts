...
export class MakeAmountLovelaceNullable1764661683000
  implements MigrationInterface
{
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "dreps" ALTER COLUMN "amount_lovelace" DROP NOT NULL`,
    );
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "dreps" ALTER COLUMN "amount_lovelace" SET NOT NULL`,
    );
  }
}
