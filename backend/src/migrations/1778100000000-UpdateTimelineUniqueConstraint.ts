...
export class UpdateTimelineUniqueConstraint1778100000000 implements MigrationInterface {
  name = 'UpdateTimelineUniqueConstraint1778100000000';

  public async up(queryRunner: QueryRunner): Promise<void> {
    // Drop the old index created by the indexer
    await queryRunner.query(`DROP INDEX IF EXISTS "uniq_drep_timeline_tx_event"`);
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`DROP INDEX IF EXISTS "uniq_drep_timeline_tx_event_type"`);
