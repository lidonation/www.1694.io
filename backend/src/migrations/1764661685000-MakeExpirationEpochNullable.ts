...
export class MakeExpirationEpochNullable1764661685000
  implements MigrationInterface
{
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "proposals" ALTER COLUMN "expiration_epoch" DROP NOT NULL`,
    );
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "proposals" ALTER COLUMN "expiration_epoch" SET NOT NULL`,
    );
  }
}
