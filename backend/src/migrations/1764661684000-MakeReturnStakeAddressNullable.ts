...
export class MakeReturnStakeAddressNullable1764661684000
  implements MigrationInterface
{
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "proposals" ALTER COLUMN "return_stake_address" DROP NOT NULL`,
    );
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "proposals" ALTER COLUMN "return_stake_address" SET NOT NULL`,
    );
  }
}
