                        ...
                        <div class="relative flex gap-4">
                            ...
                            <div class="flex justify-end flex-1 md:justify-center">
                                ...
                                <div x-data="{ open: false }" x-on:click.away="open = false">
                                    ...
                                    <nav class="hidden pointer-events-auto md:block" x-bind:class="{ 'block': open, 'hidden': !open }">
                                        <ul class="flex px-3 py-0 text-sm font-medium rounded-full shadow-lg bg-white/90 text-zinc-800 shadow-zinc-800/5 ring-1 ring-zinc-900/5 backdrop-blur dark:bg-zinc-800/90 dark:text-zinc-200 dark:ring-white/10">
                                            <li class="mb-0 list-none">
                                                <a class="relative block px-3 py-2 transition text-teal-500  dark:hover:text-teal-400" href="/" wire:navigate>Home</a>
                                            </li>
                                            <li class="mb-0 list-none">
                                                <a class="relative block px-3 py-2 transition dark:hover:text-teal-500  dark:text-white" href="/workshops" wire:navigate>Workshops
