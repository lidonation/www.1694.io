        ...
        <table class="w-full border border-collapse divide-y divide-gray-200">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="px-6 py-3 border">A motion to create a state of no-confidence in the current constitutional committee</td>
                ...
                <!-- Row 3 -->
                <tr>
                    <td class="px-6 py-3 border">3. Updates to the Constitution</td>
                    <td class="px-6 py-3 border">A modification to the off-chain Constitution, recorded as an on-chain hash of the text document</td>
                ...
                <tr>
                    ...
                    <td class="px-6 py-3 border">Any change to <b>one or more </b>updatable protocol parameters, excluding changes to major protocol versions ("hard forks")</td>
                ...
                <tr>
                    ...
                    <td class="px-6 py-3 border">An action that has no effect on-chain, other than an on-chain record.</td>
